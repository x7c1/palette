...
- A Workflow is suspended when a [Permission Supervisor](../worker/supervisor/permission-supervisor/) raises an [Escalation](../escalation/). The Operator responds, and the Workflow resumes.
